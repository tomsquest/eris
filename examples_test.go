...
// todo: manually test how stack corrections work when using a "global" error value
//       that wasn't created via eris.NewGlobal (e.g. the root error stack will be
//       wrong and might cause issues when trying to insert wrap frames into it)
